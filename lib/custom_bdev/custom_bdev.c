...
/* For now, provide a test application that uses the concepts */
#ifdef CUSTOM_BDEV_TEST_APP
...
int main(int argc, char *argv[])
{
    ...
    printf("Custom Bdev Test Application\n");
    printf("==============================\n");
    ...
    if (max_iops > 0 || max_bw_mb > 0) {
        rate_limit_init(&ctx->rate_limit, max_iops, max_bw_mb);
    }
